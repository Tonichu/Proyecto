...
<head>
  ...
  <link rel="stylesheet" href="../../librerias/css/profesor/modificar_perfil_profesor.css">
...
<body>
  ...
  <div class="container">
    ...
    ?>
    <form action="modificacion_perfil_profesor.php" method="POST" enctype="multipart/form-data" class="mt-3">
      ...
      <div class="text-center">
        ...
        <a href="../usuarios/usuario_profe.php" class="btn btn-secondary">Cancelar</a>
      </div>
    </form>
  </div>
  ...
  <script src="../../librerias/javascript/modificar_perfil_profesor.js" defer></script>
