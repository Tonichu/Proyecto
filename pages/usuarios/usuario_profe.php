...
<body>
  ...
  <div class="container mt-5">
    <!-- Aquí va tu lógica PHP para mostrar tablas u otros elementos -->
    ...
    <h2>Tus clases</h2>
    <?php if (mysqli_num_rows($resultClases) > 0) { ?>
      <table class="tabla">
        <thead>
          <tr>
            <th>ID</th>
          ...
          <?php while ($row = mysqli_fetch_assoc($resultClases)) { ?>
            <tr>
              ...
              <td>
                ...
                <a href="../../pages/area_profesor/eliminar_clase_profesor.php?id=<?php echo $row['id_clases']; ?>"
                  class="btn btn-danger">Eliminar</a>
                <!-- Botón para modificar la clase -->
                <a href="../../pages/area_profesor/modificar_clase_profesor.php?id=<?php echo $row['id_clases']; ?>"
      ...
      <?php while ($row = mysqli_fetch_assoc($resultInscripciones)) { ?>
        <tr>
          ...
          <td>
            ...
            <a
              href="../../pages/area_profesor/eliminar_sesion_profesor.php?id=<?php echo $row['id']; ?>"><button>Eliminar</button></a>
            <!-- Botón para modificar la sesion -->
            <a
              href="../../pages/area_profesor/modificar_sesion_profesor.php?id=<?php echo $row['id']; ?>"><button>Modificar</button></a>
          </td>
        </tr>
      <?php } ?>
    </table>
